...
namespace MarriageOverhaul
{
    ...
    /// <summary>Per-spouse date-night configuration.</summary>
    public class DateInfo
    {
        public string LocationName; // human-readable place
        public string Ask;          // morning invitation line
    ...
    public static class SpouseContent
    {
        ...
        //  DATE NIGHTS
        // ─────────────────────────────────────────────────────────────
        private static readonly Dictionary<string, DateInfo> Dates = new Dictionary<string, DateInfo>
        {
            ["Abigail"] = new DateInfo { LocationName = "the mine entrance",
                Ask = "Hey — wanna do something together tonight? Meet me out by the mine entrance around 8. It'll be fun, promise!",
                Scene = "Standing at the mouth of the mines with you, the cool air rushing out... Abigail grins and squeezes your hand. \"Just us against the dark. I love this.\"" },
            ["Penny"] = new DateInfo { LocationName = "the library",
                Ask = "Would you like to spend the evening together? Maybe meet me at the library around 8? I'd love that.",
                Scene = "Among the quiet shelves, Penny reads softly to you by lamplight. She rests her head on your shoulder. \"This is perfect. Just perfect.\"" },
            ["Haley"] = new DateInfo { LocationName = "the beach",
                Ask = "Let's do something tonight, just the two of us. Meet me at the beach at 8 — and wear something cute.",
                Scene = "Waves shimmering under the moon, Haley snaps a photo of the two of you. \"This one's a keeper. ...So are you, I guess.\"" },
            ["Emily"] = new DateInfo { LocationName = "the town square",
                Ask = "The stars are calling for us tonight. Meet me in the town square at 8 and we'll dance beneath them?",
                Scene = "Emily twirls under the stars in the empty square, pulling you into the dance. \"Feel that? Our spirits, in rhythm. Bliss.\"" },
            ["Leah"] = new DateInfo { LocationName = "the forest clearing",
                Ask = "Come share the evening with me? Meet me out in the forest clearing around 8. I'll bring wine.",
                Scene = "A blanket in the clearing, wine in hand, the trees whispering. Leah smiles. \"This is the life I dreamed of. With you in it.\"" },
            ["Maru"] = new DateInfo { LocationName = "the mountain lake",
                Ask = "Want to spend tonight together? Meet me up at the mountain lake at 8 — clear skies, perfect for stargazing.",
                Scene = "Telescope set up by the lake, Maru points out a constellation. \"Out of all the stars... you're still the one I'd pick. Every time.\"" },
            ["Alex"] = new DateInfo { LocationName = "the beach",
                Ask = "Hey, let's hang out tonight, just us! Meet me down at the beach at 8. It's gonna be awesome.",
                Scene = "Tossing a gridball back and forth on the moonlit sand, Alex laughs. \"Man, this is the good stuff. Me, you, the waves. Perfect.\"" },
            ["Elliott"] = new DateInfo { LocationName = "the beach pier",
                Ask = "Might you join me this evening? Meet me upon the beach pier at 8, where the sea writes its poetry.",
                Scene = "On the pier, Elliott recites a verse he wrote just for you as the tide rolls in. \"You are the muse behind every line, my love.\"" },
            ["Harvey"] = new DateInfo { LocationName = "the clinic rooftop",
                Ask = "Would you, ah, care to join me tonight? Meet me up on the clinic rooftop at 8. The view is rather lovely.",
                Scene = "On the rooftop, Harvey nervously points out the planes overhead, then just holds your hand. \"This... this is wonderful. Thank you.\"" },
            ["Sam"] = new DateInfo { LocationName = "the town square",
                Ask = "Yo, let's do something tonight! Meet me in the town square at 8, I'll bring my skateboard and we'll mess around.",
                Scene = "Sam shows off a clumsy kickflip, nearly wipes out, and you both crack up. \"Best date ever, dude. For real. You're awesome.\"" },
            ["Sebastian"] = new DateInfo { LocationName = "the lake by the mountain",
                Ask = "Hey... wanna do something tonight? Meet me by the mountain lake at 8. It's quiet up there. I like it.",
                Scene = "Skipping stones across the still lake in comfortable silence, Sebastian finally smiles. \"...I don't do this with anyone but you.\"" },
            ["Shane"] = new DateInfo { LocationName = "Cindersap by the cliffs",
                Ask = "Hey, uh... you wanna get out tonight? Meet me by the cliffs in Cindersap at 8. The view's good there.",
                Scene = "Watching the sunset over the water from the cliffs, Shane lets out a slow breath. \"This is nice. Real nice. ...Thanks for this.\"" }
        };

        private static readonly DateInfo GenericDate = new DateInfo
        {
            LocationName = "the town square",
            Ask = "Would you like to spend the evening together? Meet me in the town square around 8 tonight.",
            Scene = "Under the evening sky, your spouse takes your hand and smiles. \"Just the two of us. This is exactly what we needed.\""
        };

        public static DateInfo GetDate(string name)
            => IsVanilla(name) && Dates.ContainsKey(name) ? Dates[name] : GenericDate;

        // ─────────────────────────────────────────────────────────────
        //  MOVIE THEATER DATES (only once the theater is unlocked)
        // ─────────────────────────────────────────────────────────────
        private static readonly Dictionary<string, DateInfo> MovieDates = new Dictionary<string, DateInfo>
        {
            ["Abigail"] = new DateInfo { LocationName = "the movie theater",
                Ask = "Hey! The theater's playing something tonight — wanna sneak in some candy and catch a movie with me at 8?",
                Scene = "In the flickering dark, Abigail shares her smuggled snacks and whispers wild plot theories in your ear. \"Way better than the mines tonight. Don't tell anyone I said that.\"" },
            ["Penny"] = new DateInfo { LocationName = "the movie theater",
                Ask = "Would you like to see a movie tonight? I've never been able to afford the theater before... meet me there at 8?",
                Scene = "Penny watches the screen wide-eyed, hand wrapped in yours. As the credits roll she sighs. \"I'll remember this night for a long, long time. Thank you.\"" },
            ["Haley"] = new DateInfo { LocationName = "the movie theater",
                Ask = "There's a movie playing tonight and I want to be seen on a proper date. Theater, 8 o'clock, look cute. Got it?",
                Scene = "Haley snaps a selfie of you both in your seats before the lights dim, then leans on your shoulder all film. \"Okay, fine, this is officially adorable.\"" },
            ["Emily"] = new DateInfo { LocationName = "the movie theater",
                Ask = "The theater's energy is calling to us tonight. Come share a film with me at 8? I'll feel every frame.",
                Scene = "Emily sways to the score and squeezes your hand at every twist. \"Stories are just shared dreams, you know. And I got to dream this one with you.\"" },
            ["Leah"] = new DateInfo { LocationName = "the movie theater",
                Ask = "Fancy a movie tonight? It's been ages since I sat in a real theater. Meet me there at 8 — I'll grab the popcorn.",
                Scene = "Leah critiques the cinematography in a low murmur, then quietly admits she loved it. \"Good art, good company. Yeah. This was perfect.\"" },
            ["Maru"] = new DateInfo { LocationName = "the movie theater",
                Ask = "Want to catch the showing tonight? I'm curious about the projection setup, honestly. Meet me at the theater at 8?",
                Scene = "Maru explains how the projector works for exactly thirty seconds, then gets completely absorbed in the film. \"...Okay, that was incredible. And so are you.\"" },
            ["Alex"] = new DateInfo { LocationName = "the movie theater",
                Ask = "Yo, movie night? Theater at 8! I'll buy the giant popcorn, you're not stoppin' me.",
                Scene = "Alex narrates the action scenes a little too loudly until you shush him, grinning. He grins back. \"Best seat in the house, right next to you.\"" },
            ["Elliott"] = new DateInfo { LocationName = "the movie theater",
                Ask = "Shall we attend the cinema this evening? A story told in light and shadow, shared with you — meet me at the theater at 8.",
                Scene = "Elliott is moved to quiet tears by the ending and dabs his eyes theatrically. \"Ah, what a tale. Though no plot rivals the one I'm living, here with you.\"" },
            ["Harvey"] = new DateInfo { LocationName = "the movie theater",
                Ask = "I, ah, wondered if you'd join me for a film tonight? The theater, at 8? I'll even spring for snacks.",
                Scene = "Harvey nervously offers you the armrest, then the popcorn, then his hand. By the finale he's beaming. \"This was simply lovely. Thank you, truly.\"" },
            ["Sam"] = new DateInfo { LocationName = "the movie theater",
                Ask = "Dude, movie tonight?! Theater at 8! I call dibs on the blue slushie, but I'll share. Maybe.",
                Scene = "Sam reenacts the best stunt with his hands and nearly knocks over the popcorn, cracking you both up. \"Okay that ruled. You rule. Tonight rules!\"" },
            ["Sebastian"] = new DateInfo { LocationName = "the movie theater",
                Ask = "Hey... there's a movie on tonight. Could be cool to just sit in the dark and watch something. Theater at 8?",
                Scene = "Sebastian doesn't say much, but somewhere in the dark his hand finds yours and stays there. As the lights rise: \"...Yeah. I had a really good time.\"" },
            ["Shane"] = new DateInfo { LocationName = "the movie theater",
                Ask = "Uh, hey — there's a movie playing tonight. Haven't done somethin' like that in years. Meet me at the theater at 8?",
                Scene = "Shane relaxes by degrees as the film plays, and you catch him actually smiling in the glow. \"Forgot what this felt like. Just... bein' happy. Thanks for this.\"" }
        };

        private static readonly DateInfo GenericMovieDate = new DateInfo
        {
            LocationName = "the movie theater",
            Ask = "There's a movie playing in town tonight. Would you like to go together? Meet me at the theater at 8.",
            Scene = "Side by side in the darkened theater, your spouse leans close as the film plays. \"I'm so glad we did this. Just us and the big screen.\""
        };

        public static DateInfo GetMovieDate(string name)
