    ...
    public static partial class ExtendedContent
    {
        ...
        private static readonly Dictionary<string, List<SpouseRequest>> Requests = new Dictionary<string, List<SpouseRequest>>
        {
            ...
            ["Emily"] = new List<SpouseRequest> {
                new SpouseRequest { Id = "emily_cloth", Note = "Beloved,^Would you bring me some cloth? I feel a creation calling to me, and I want to weave a little of our energy into it. Whenever the universe allows.^- Emily", Items = new[] { "Cloth" }, Thank = "Cloth! I can already feel what it wants to become. A piece of us, woven together. Thank you, my love.", RewardItem = "Aquamarine", RewardLine = "The weaving is done — but something else took shape while I worked. I charged this stone with the energy flowing between us. Keep it close, beloved; it'll hum softly whenever my thoughts drift to you." },
